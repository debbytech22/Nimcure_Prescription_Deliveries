    ...
    scanBtn.addEventListener("click", () => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                isPackageReady = true; // Mark package as ready after successful scan
...
function initializeModalAndBlur() {
    ...
    assignPackageBtn.addEventListener("click", () => {
        ...
        if (!isPackageReady) {
            console.log("Package is not ready. Cannot proceed to modal overlay.");
            return; // Prevent modal overlay from being displayed
        }
